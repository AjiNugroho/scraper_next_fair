...
import { usePhylloScrapeJobs, type PhylloScrapeJobRun } from "../datahooks/usePhylloScrapeJobs"
import { TriggerPhylloScrapeJobDialog } from "./TriggerPhylloScrapeJobDialog"
...
const columns: ColumnDef<PhylloScrapeJobRun>[] = [
  {
...
export function PhylloScrapeJobsTable() {
  const router = useRouter()
  const [page, setPage] = useState(0)
  const { data, isLoading, refetch, isFetching } = usePhylloScrapeJobs(page, PAGE_SIZE)
