...
import { useTokopediaWorkers } from "../datahooks/useTokopediaWorkers"
...
export function TokopediaWorkersManagement() {
  const [deleteTarget, setDeleteTarget] = useState<TokopediaWorker | null>(null)
  const [hashtagsTarget, setHashtagsTarget] = useState<TokopediaWorker | null>(null)

  const { data, isLoading, isError } = useTokopediaWorkers()
  const workers = data?.workers ?? []

  const columns = useMemo<ColumnDef<TokopediaWorker>[]>(
    () => [
      {
        accessorKey: "name",
        header: "Name",
